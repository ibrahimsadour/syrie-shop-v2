<div class="navigation--list">
    <div class="navigation__content">
        ...
        <a class="navigation__item " href="{{route('products.create.step.one')}}" style="border-radius: 5px;background: #fcb800;padding: 5px 5px;color: black;" ><i class="icon-plus-circle" style="font-weight: 700;"></i><span style="font-weight: 700;"> أضف أعلانك </span></a>
