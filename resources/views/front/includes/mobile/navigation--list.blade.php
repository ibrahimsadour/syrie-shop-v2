<div class="navigation--list">
    <div class="navigation__content">
        ...
        <a class="navigation__item ps-toggle--sidebar" style="border-radius: 5px;background: #fcb800;padding: 5px 5px;" href=""><i class="icon-plus-circle" style="font-weight: 700;"></i><span style="font-weight: 700;"> أضف أعلانك </span></a>
        <a class="navigation__item ps-toggle--sidebar" href="#search-sidebar"><i class="icon-magnifier"></i><span> البحث</span></a>
        <a class="navigation__item ps-toggle--sidebar" href="#cart-mobile"><i class="icon-bag2"></i><span> السلة</span></a>
    </div>
</div>